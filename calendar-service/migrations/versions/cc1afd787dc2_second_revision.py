...
Revision ID: cc1afd787dc2
Revises: 
Create Date: 2025-08-16 15:39:39.728437
...
def upgrade() -> None:
    ...
    sa.Column('event_type', sa.Enum('TASK', 'MEETING', 'PERSONAL', 'HOLIDAY', 'OTHER', name='eventtype'), nullable=False),
